...
export const responseToUser = async (req, res, next) => {
    ...
    try {
        ...
        console.error('Error in responseToUser:', error);
...
// ! WILL BE REMOVED !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
>>>>>>> eeec82646b5119a84af652c647f03fc1bddf3249
...
// Capture user answers and generate follow-up questions using OpenAI
export const catchAnswers = async (req, res, next) => {
    try {
        ...
        If the response is vague, transition to the topic: '${question}'.`;
        ...
        console.error('Error in catchAnswers:', error);
