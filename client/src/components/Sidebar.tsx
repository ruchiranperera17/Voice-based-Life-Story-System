...
const Sidebar = () => {
  return (
    <div className="fixed inset-y-0 left-0 z-30 w-64 h-screen overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
      ...
      <nav className="mt-10">
        ...
        >
          ...
          <span className="mx-3">Sample Category</span>
        </a>
